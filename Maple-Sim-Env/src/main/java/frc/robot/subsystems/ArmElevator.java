...
public class ArmElevator extends SubsystemBase {
    ...
    public ArmElevator() {
        ...
        m_elevatorLigament =
            m_root.append(
                new MechanismLigament2d("Elevator", getElevatorHeight(), 90, 6, new Color8Bit(Color.kBlue)));
        m_armLigament =
            m_elevatorLigament.append(
    ...
    public void periodic() {
        ...
        double elevatorPidOutput = m_elevatorPid.calculate(m_elevatorEncoder.getDistance(), m_elevatorSetpoint.position);
        ...
        m_armLigament.setAngle(getArmAngle());
    }
    ...
    public boolean atSetpoint() {
        boolean atElevatorGoal = Math.abs(getElevatorHeight() - m_elevatorGoal.position) < Constants.Elevator.kTolerance;
